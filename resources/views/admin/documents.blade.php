...
@section ('admincontent')
    ...
    <div class="d-sm-flex align-items-center justify-content-between shadow-4 mb-2">
        <h1 class="h3 mb-0 text-gray-dark">Regulaciones</h1>
        <a href="#" class="d-none d-xl-inline-block btn btn-sm btn-navbar shadow-sm navbar-blue-u open-modal"
           data-toggle="modal" data-target="#DocumentAddModal" data-open="DocumentAddModal">
            <i class="fas fa-user-plus fa-sm mr-1 text-white"></i>Agregar Regulación</a>
    </div>
                ...
                <form action="/admin/documents" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="modal-body">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <input id="trimester" type="number" min="1" max="4" onkeypress="return (event.charCode !=8 && event.charCode ==0 || (event.charCode >= 48 && event.charCode <= 57))" class="form-control" name="trimester"
                ...
                <form action="{{URL('/admin/documents/update')}}" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="modal-body">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <input id="trimesteredit" type="numer" min="1" max="4" onkeypress="return (event.charCode !=8 && event.charCode ==0 || (event.charCode >= 48 && event.charCode <= 57))" class="form-control" name="trimester" required>
                            </div>
                        </div>
                        <div class="form-group row">
                        ...
                        <input type="hidden" class="form-control" id="doctypeedit" placeholder="" name='doctypeedit' required>
                    </div>
                    <div class="modal-footer">
                        <button type="button" class="btn btn-secondary" data-dismiss="modal">Cerrar</button>
