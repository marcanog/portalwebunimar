...
@section('content')
    <div class="content">
        <div class="banner-main">
            <img src="{{URL::asset('/image/banners/'.trans('commons.lang-banner').'/news/newsunimar.jpg')}}">
        </div>
{{--Section info--}}
        <div class="section-content">
            <div class="d-flex justify-content-start">
                <img id="img-section"
                     src="{{URL::asset('./image/views/'.trans('commons.lang-banner').'/norms/norms-02.png')}}">
                <h4>{{trans('newsu.n-title')}}</h4>
            </div>
        </div>
...
{{--                             <img src="{{ asset('plugins/tech-blog/upload/tech_01.jpg') }}" alt="" class="img-fluid">--}}
...
{{--                        <div class="masonry-box post-media">--}}
{{--                             <img src="{{ asset('plugins/tech-blog/upload/tech_02.jpg') }}" alt="" class="img-fluid">--}}
{{--                             <div class="shadoweffect">--}}
{{--                                <div class="shadow-desc">--}}
{{--                                    <div class="blog-meta">--}}
{{--                                        <span class="bg-orange"><a href="#" title="" class="last-news-tags tags-id"></a></span>--}}
...
{{--                        <div class="masonry-box post-media">--}}
{{--                             <img src="{{ asset('plugins/tech-blog/upload/tech_03.jpg') }}" alt="" class="img-fluid">--}}
{{--                             <div class="shadoweffect">--}}
{{--                                <div class="shadow-desc">--}}
{{--                                    <div class="blog-meta">--}}
{{--                                        <span class="bg-orange"><a href="#" title="" class="last-news-tags tags-id"></a></span>--}}
            ...
            <div class="container">
                <div class="row">
                    <div class="col-lg-9 col-md-12 col-sm-12 col-xs-12">
                        ...
                        @foreach($news as $new)
                            <div class="blog-box row my-2">
                                <div class="col-md-4">
                                    <div class="post-media">
                                        <a href="/newsunimar/.{{$new->first_tag}}/{{$new->title}}/{{$new->id}}" title="">
                                            <img src={{ asset("image/newsimg/$new->image") }} class="img-fluid">
