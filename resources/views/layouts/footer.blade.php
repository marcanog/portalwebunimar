<div class="footer col-sm-12" id="footerdesktop">
    <div class="footer-item">
        <div class="info-university">
            <img src={{URL::asset('./image/logo-unimar-22.png')}}>
        ...
        <div class="offers">
            <div>
                <ul>
                    <li class="footer-item">
                        <a class="footer-title font-weight-bold" href="{{url('/study-offers')}}">
        ...
        <div class="webs-service">
            <div>
                <ul>
                    ...
                    <li class="footer-item">
                        <a class="footer-title " href="{{url('/services')}}">
                            {{trans('footer.f_servacad')}}
                        </a>
                    </li>
                    <li class="footer-item">
                        <a class="footer-title " href="{{url('/library')}}">
                            {{trans('footer.f_library')}}
                        </a>
                    </li>
                    <li class="footer-item">
        ...
        <div class="quickly-access">
            <div>
                <ul>
                    ...
                    <li class="footer-item">
                        <a class="footer-title" style="color: #ffffff !important">{{trans('footer.f_contact_us')}}</a>
                    </li>
                </ul>
                <div class="rrss">
                    <ul class="d-flex justify-content-center list-unstyled">
                        ...
                        <li class="nav-item px-1">
                            ...
                            <a href="https://www.youtube.com/channel/UCnRVkJ1OW2oLN_TpvXAnUyw">
                                <img class="w-6 h-6" src={{URL::asset('/image/rrss/youtube-03.png')}}>
                            </a>
                        </li>
                        <li class="nav-item px-1">
                            <!-- <a onclick="rrss()"> -->
