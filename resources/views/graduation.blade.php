...
@section ('content')
    <div class="content">
        ...
        <div id="owl-example" class="owl-carousel owl-theme">
            <div class="owl_text"><img src="{{URL::asset('./image/views/'.trans('commons.lang-banner').'/ceremonies/list-xxxvii/listados-portada-xxxvii.png')}}" class="img_size"></div>
            ...
            <div class="owl_text"><img src="{{URL::asset('./image/views/'.trans('commons.lang-banner').'/ceremonies/list-xxxvii/comunicacion.png')}}" class="img_size"></div>
                    ...
                    <div class="row justify-content-around">
                        ...
                        <div class="col-sm-6">
                            <div class="card text-black text-left border-0 my-4">
                                ...
                                <span class="card-text">Lugar: Sala de Extensión (Todas las carreras)</span>
                                <span class="card-text fs-6 font-weight-bold">Conversatorio con el Epónimo de las Promociones XXXVII y XXXVIII.</span>
                                <span class="card-text">Hora: 11:00 a.m.</span>
                                <span class="card-text">Lugar: Sala de Conferencias II (Todas las carreras)</span>
        ...
        <div class="card-body" style="padding: 1.5rem 0">
            <ul class="nav nav-tabs" id="custom-content-below-tab" role="tablist">
                ...
                <li class="nav-item">
                    <a class="nav-link" id="vert-tabs-godmother-tab" data-toggle="pill" href="#vert-tabs-godmother" role="tab" aria-controls="vert-tabs-godmother" aria-selected="true">Madrina UCSAR</a>
                </li>
                <li class="nav-item">
                ...
                <li class="nav-item">
                    <a class="nav-link" id="vert-tabs-honorary-mentionsucsar-tab" data-toggle="pill" href="#vert-tabs-honorary-mentionsucsar" role="tab" aria-controls="vert-tabs-honorary-mentionsucsar" aria-selected="false">Menciones Honoríficas UCSAR</a>
                </li>
            </ul>
            <div class="tab-content" id="custom-content-below-tabContent">
                <div class="tab-pane fade show active" id="vert-tabs-schedule" role="tabpanel" aria-labelledby="vert-tabs-schedule-tab">
                    <div class="banner-main">
                        <img src="{{URL::asset('./image/views/'.trans('commons.lang-banner').'/ceremonies/list-xxxvii/padrinos-xxxvii.png')}}" width="100%">
                    </div>
                </div>
                <div class="tab-pane fade" id="vert-tabs-godmother" role="tabpanel" aria-labelledby="vert-tabs-godmother-tab">
                    <div class="banner-main">
                        <img src="{{URL::asset('./image/views/'.trans('commons.lang-banner').'/ceremonies/list-xxxvii/madrinaucsar-xxxvii.jpg')}}" width="100%">
                    </div>
                </div>
                <div class="tab-pane fade" id="vert-tabs-acknowledgments" role="tabpanel" aria-labelledby="vert-tabs-acknowledgments-tab">
                    <div class="banner-main">
                        <img src="{{URL::asset('./image/views/'.trans('commons.lang-banner').'/ceremonies/list-xxxvii/reconocimientos-xxxvii.png')}}" width="100%">
                    </div>
                </div>
                <div class="tab-pane fade" id="vert-tabs-honorary-mentions" role="tabpanel" aria-labelledby="vert-tabs-honorary-mentions-tab">
                    <div class="banner-main">
                        <img src="{{URL::asset('./image/views/'.trans('commons.lang-banner').'/ceremonies/list-xxxvii/menciones-honorificas-xxxvii.png')}}" width="100%">
                    </div>
                </div>
                <div class="tab-pane fade" id="vert-tabs-honorary-mentionsucsar" role="tabpanel" aria-labelledby="vert-tabs-honorary-mentionsucsar-tab">
                    <div class="banner-main">
                        <img src="{{URL::asset('./image/views/'.trans('commons.lang-banner').'/ceremonies/list-xxxvii/menciones-honorificasucsar-xxxvii.jpg')}}" width="100%">
                    </div>
                </div>
            </div>
        </div>
